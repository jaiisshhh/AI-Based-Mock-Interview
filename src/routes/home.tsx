      ...
      <Container>
        <div className="my-8">
          ...
          <p className="mt-4 text-muted-foreground text-sm">
            ...
            AI-driven insigts. Discover a smarter way to prepare, practice,
            stand out.
          </p>
        </div>

        <div className="flex w-full items-center justify-evenly md:ox-12 md:py-16 md:items-center md:justify-end gap-12">
